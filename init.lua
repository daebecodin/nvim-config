...
-- Navigation handled by tmux.nvim (aserowy/tmux.nvim)
...
--    :Lazy update
--
-- NOTE: Plugins have been split into separate files under lua/plugins/
--  Each file returns a plugin spec that lazy.nvim loads automatically.
--
